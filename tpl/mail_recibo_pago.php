<html lang="es"><!--<![endif]--><head>
    <meta charset="utf-8">
    <title>Coffebox | <?=$implementacion_nombre?></title>
                                    ...
                                    <tbody><tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tbody><tr>
                                                    <td>
                                                        <a href="#"><img src="<?=base_url().$logo?>" style="height:100px;width: auto"></a>
                                                    </td>
                        ...
                        <td>
                                        ...
                                        <table class="twelve columns">
                                            <tbody><tr>
                                                <td class="last">
                                                    ...
                                                    <p class="m-b-5">Te adjuntamos a este correo el recibo  de pago N° <?=$id_pago?> </p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-t-15 last">Muchas gracias.</p>
                                                </td>
                                            </tr>                                            
                                        </tbody></table>
                                    </td>
                            ...
                            <table class="row">
                                <tbody><tr>
                                    ...
                                    <td class="wrapper">                                       
                                        <p>
                                            <i>AVISO LEGAL La información contenida en este mensaje, y en cualquier archivo asociado al mismo, es confidencial y está destinada exclusivamente a su destinatario. Si usted no lo es, y por error lo ha recibido, por favor reenvíelo a su emisor indicando tal situación y luego elimínelo. La información contenida en este mensaje está sujeta asimismo a las normas de confidencialidad y de utilización de sistemas y de la información de <?=$implementacion_nombre?> respecto de aquellos que han sido notificados expresamente de las mismas. La distribución, reproducción o copia de lo arriba expresado está prohibida y corresponden a su autor. No debe interpretarse que pertenezcan o sean compartidas por <?=$implementacion_nombre?>, quien no se responsabiliza por errores u omisiones producidas, ni garantiza la certeza de lo transmitido por este medio debido a que puede ser objeto de interpretación, alteración, demora, contener virus u otras anomalías.</i>
                                        </p>
                                    </td>
                                    <!-- end wrapper -->
                                </tr>
