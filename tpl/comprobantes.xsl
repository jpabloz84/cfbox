         ...
         <xsl:value-of select="/xml/rs:data/z:row[position()=1]/@tipo"/>
              ...
              <tbody>
                <tr>
                  <td style="border-right-style: groove;">
                    <table style="height:38px;margin-bottom:10px;width:297px;">
                      <thead></thead>
                       <tbody>
                        <tr><td style="font-size:18px;text-align: center;" ><xsl:value-of select="/xml/rs:data/z:row[position()=1]/@empresa"/></td></tr>
                  ...
                  <td>
                    <table   class="tblcliente2">          
                      ...
                      <tr>
                        <td colspan="2">Cuit: <xsl:value-of select="/xml/rs:data/z:row[position()=1]/@empresa_cuil"/></td>
                    </tr>
          ...
          <div style="width: 100%;border-top-style: double; ">
            <table class="tblcliente">          
                  ...
                  <tr>
                    <td>Condicion IVA:</td><td><xsl:value-of select="/xml/rs:data/z:row[position()=1]/@condicion"/> </td>
                  </tr>
                  <tr>
