                                            ...
                                            <table class="six columns">
                                                <tbody><tr>
                                                    <td class="text-right valign-middle">
                                                        <span class="template-label">Acuse de premio</span>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </tbody></table>
                                            ...
                                            <tbody>
                                             <tr>
                                                <td class="last">
                                                    ...
                                                    <p class="m-b-5">Te comentamos que has sido acreedor(a) de un premio con el cartón N° <?=$id_carton?> en el item de <?=$item?> del bingo jugado el <?=$fecha_juego?>.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="last">                                                    
                                                    <p class="m-b-5">El premio contiene: <br/> <?=$detallepremio?>.<br/>
                                                      Conserve el siguiente codigo QR y no lo comparta. Imprímalo y llevelo para canjear el/los premios en nuestras sucursales.
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="panel" style="background: #ffffff;text-align: center;">
                                                    <img src="<?=$pathimgbarcode?>" style="outline: none;text-decoration: none;width: auto;max-width: 100%;float: none !important;display: inline !important;" />
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <p class="m-t-15 last">Coordina con la organización para la entrega. <br/>Saludos cordiales!!!</p>
                                                </td>
                                            </tr>                                            
                                        </tbody></table>
                                    </td>
