<html lang="es"><!--<![endif]--><head>
    <meta charset="utf-8">
    <title>Vivobingo | <?=$implementacion_nombre?></title>
                                    ...
                                    <tbody><tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tbody><tr>
                                                    <td>
                                                        <a href="https://vivobingo.com.ar"><img src="<?=base_url()?>assets/img/vivobingo-min.png"></a>
                                                    </td>
                                            ...
                                            <table class="six columns">
                                                <tbody><tr>
                                                    <td class="text-right valign-middle">
                                                        <span class="template-label">Pago Recibido en <?=$implementacion_nombre?></span>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </tbody></table>
                    ...
                    <tbody><tr>
                        <td>
                                ...
                                <tbody><tr>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tbody><tr>
                                                <td class="last">
                                                    <h4>Hola <?=$strnombrecompleto?>.</h4>
                                                    <p class="m-b-5">Te invitamos a que inicies sesión en la web y hagas click en el siguiente enlace para ver tus cartones:</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="panel">
                                                  <ul>
                                                  <?php echo $htmlurlpagecompra; ?>
                                                  </ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-t-15 last">El dia y hora del sorteo, te invitamos a sigas el en vivo en nuestras redes sociales para seguir el sorteo. De todos modos, esto no es necesario. Si tus cartones son premiados, te avisaremos por mail o podes presentar tu dni a la organización para canjear el premio en caso de corresponder. Te deseamos MUCHA SUERTE.</p>
                                                </td>
                                            </tr>                                            
                                        </tbody></table>
                                    </td>
                            ...
                            <table class="row">
                                <tbody>
                                <td class="panel">                                    
                                    <p class="m-b-5">Te dejamos un comprobante por tu compra:</p>
                                </td>
                                <tr>
                                    <td class="panel">
                                        <a href="<?=$urlcomprobante?>"><?=$urlcomprobante?></a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="row">
                                <tbody><tr>
                                    ...
                                    <td class="wrapper">                                       
                                        <p>
                                            <i>AVISO LEGAL La información contenida en este mensaje, y en cualquier archivo asociado al mismo, es confidencial y está destinada exclusivamente a su destinatario. Si usted no lo es, y por error lo ha recibido, por favor reenvíelo a su emisor indicando tal situación y luego elimínelo. La información contenida en este mensaje está sujeta asimismo a las normas de confidencialidad y de utilización de sistemas y de la información de VIVOBINGO respecto de aquellos que han sido notificados expresamente de las mismas. La distribución, reproducción o copia de lo arriba expresado está prohibida y corresponden a su autor. No debe interpretarse que pertenezcan o sean compartidas por VIVOBINGO, quien no se responsabiliza por errores u omisiones producidas, ni garantiza la certeza de lo transmitido por este medio debido a que puede ser objeto de interpretación, alteración, demora, contener virus u otras anomalías.</i>
                                        </p>
                                    </td>
                                    <!-- end wrapper -->
                                </tr>
